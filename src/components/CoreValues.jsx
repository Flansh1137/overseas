import {
  ...
  const CoreValuesSection = () => (
    <section className="py-24 px-6 bg-gradient-to-br from-purple-100 via-white to-purple-100 text-center">
      <h2 className="text-4xl font-bold text-purple-800 mb-16">Our Core Values</h2>
