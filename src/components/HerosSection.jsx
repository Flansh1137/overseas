...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-[#9B59B6] min-h-screen px-20"> 
      ...
      <div className="container-padding relative z-10 pt-6"> {/* Reduced pt-8 to pt-6 */}
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center min-h-[calc(100vh-180px)]">
          ...
          <div className="w-full lg:w-1/2 animate-slide-in-left text-white">
            <p className="text-white/90 mb-3 text-base">Your Online Learning Partner</p> {/* reduced text-lg to text-base, mb-4 to mb-3 */}
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-5"> {/* reduced from 5xl/6xl to 4xl/5xl */}
              A Leading And Trusted Education Consultancy
            </h1>
            <p className="text-white/90 text-base mb-6 leading-relaxed max-w-lg"> {/* text-lg to base, mb-8 to mb-6 */}
  ...
  <Button
    size="lg"
    className="bg-yellow-300 hover:bg-yellow-500 text-black font-semibold text-lg px-6 py-3 rounded-xl transition-colors duration-300"
  >
    Get Started Now
  </Button>
  ...
  <Button
    size="lg"
    className="bg-[#9B59B6] hover:bg-yellow-500 text-black font-semibold text-lg px-6 py-3 rounded-xl transition-colors duration-300"
  >
    Book Appointment
  </Button>
</div>
            ...
            <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-sm rounded-xl p-3 max-w-sm">
              <div className="flex -space-x-2">
                <div className="w-9 h-9 bg-gray-300 rounded-full border-2 border-white flex items-center justify-center text-sm">👨🏻</div>
                <div className="w-9 h-9 bg-gray-300 rounded-full border-2 border-white flex items-center justify-center text-sm">👩🏽</div>
                <div className="w-9 h-9 bg-teal-700 text-white font-bold rounded-full border-2 border-white flex items-center justify-center text-sm">+</div>
              </div>
              <div>
                <div className="flex items-center space-x-1 mb-1">
                  <span className="text-xl font-bold text-white">4.8</span> {/* reduced from 2xl */}
          ...
          <div className="w-full lg:w-1/2 animate-slide-in-right relative">
            <img src={studentImage} alt="Happy student" className="w-[90rem] absolute top-[-20rem]" /> {/* Reduced width from 102rem to 90rem */}
